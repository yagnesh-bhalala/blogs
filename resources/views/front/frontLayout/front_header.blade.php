    ...
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ url('public/frontend/image/logo_main.png1') }}" alt="logo" class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end pr-3" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                */ ?>
                ...
                <li class="nav-item px-2 {{ (Request::path()== 'articles' || Request::path()== 'article-details') ? 'active' : '' }}">
