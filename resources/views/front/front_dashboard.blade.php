...
<div class="main_header_Section main_title_img">
    ...
    <div class="text_on_img col-xl-12 col-lg-12 col-md-12 d-flex justify-content-center flex-wrap pt-5">
        <div class="col-xl-5 col-lg-7 col-md-11 ">
            <div class="text_head">
                <p class="py-4">Experience the <b>easiest</b> way to balance your <b>bills and spending</b> with The <b>B-DEMO </b> <sup>TM</sup> </p>
        ...
        <div class="col-xl-12 ">
            <div class="col-xl-8 col-lg-9 col-md-12 col-12 mx-auto">
                <div class="treck_Sec text-center">
                    ...
                    <h4>B-DEMO  <SUP>TM</SUP> application</h4>
                </div>
            </div>
            <div class="col-xl-8 col-lg-6 col-md-10 col-12 mx-auto text-center my-4 small_treck">
                <p>The app is easy to use and was designed for people of all ages.
                    ...
                    But to experience the full potential of The B-DEMO  link your financial institutions.!
                    With The <b> B-DEMO  </b> <sup>TM</sup> you get:
                </p>
            ...
            <div class="col-xl-9 col-lg-11 col-md-11 col-sm-12 d-flex align-items-center justify-content-center mx-auto cream_bg flex-wrap">
                <div class="col-xl-6 col-lg-6 col-md-7 order-md-1 order-2">
                    <div class="text_sectin_side left_side">
                        ...
                        <p>The application reminds you of all the due dates so you never miss a payment. With the help of The B-DEMO  you can make every payment on time.</p>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="col-xl-8 col-lg-10 col-md-10 col-12 mx-auto text-center how_work_title">
                        ...
                        <p>
                            ...
                            The B-DEMO  TM uses The Bill Balancer TM (Patent Pending) to split your bills prior to the due date.
        ...
        <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 d-flex align-items-center justify-content-center mx-auto flex-wrap">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="printing_text">
                    ...
                    <span>with the B-DEMO <sup> TM </sup></span>
                    </h4>
        ...
        <div class="col-xl-12 midddal_sec_main owl-carousel owl-theme">
            ...
            <div class="slider_main_section item ">
                <div class="white_box_slider">
                    ...
                    <div class="discription_about">
                        <p>Grade 9</p>
                        <p class="pt-4">I am so excited I downloaded the $5  app! Each feature of this app helps me to create a balance of my bills and always have money in my pocket!  The app lets me see into the future so I can make sure I have enough money to pay future bills. This kind of detail would be impossible to know without the $5 . I highly recommend it!</p>
                    </div>
            ...
            <div class="slider_main_section item ">
                <div class="white_box_slider">
                    ...
                    <div class="discription_about">
                        <p>Grade 12</p>
                        <p class="pt-4">This app has allowed me to have the same amount of spending money each pay check. I stopped spending money I didn’t really have. I even started saving! Thank you $5 ! And the Bill Balancer is really cool too!</p>
                    </div>
            ...
            <div class="slider_main_section item ">
                <div class="white_box_slider">
                    ...
                    <div class="discription_about">
                        <p>Grade 10</p>
                        <p class="pt-4">I have used many finance management applications, but have never found any application as efficient as B-DEMO . Totally loved it.</p>
                    </div>
