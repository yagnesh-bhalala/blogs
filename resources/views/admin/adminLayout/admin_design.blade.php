...
<head>
  ...
  <title>B-DEMO Bill | @php echo isset($breadcrumb['page']['headTitle']) ? $breadcrumb['page']['headTitle'] : 'Dashboard' @endphp </title>
  ...
  <link rel="stylesheet" href="{{ url('public/backend/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css') }}">
  <!-- iCheck -->
...
<!-- Bootstrap4 Duallistbox -->
<script src="{{ url('public/backend/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>
<!-- ChartJS -->
...
<script src="{{ url('public/backend/js/admin_script.js') }}"></script>
<!-- SwweetAlert Script -->                                 
...
@endif
<input type="hidden" value="{{ env('APP_URL') }}" name="app_url" />
</body>
</html>
